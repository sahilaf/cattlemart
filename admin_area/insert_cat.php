...
if (!isset($_SESSION['admin_email'])) {
				...
				<div class="panel panel-default">
					<div class="panel-heading"><!--panel-heading start-->
						<h3 class="panel-title">
							<i class="fa fa-money fa-fw"> Insert Cattle </i>
						</h3>
					...
					<div class="panel-body">
						<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
							<div class="form-group">
								...
								<input type="text" name="breed" class="form-control" placeholder="Enter product title"
									required="">
							</div>
							...
							<div class="form-group">
								...
								<input type="text" name="age" class="form-control" placeholder="Enter price" required="">
							</div>
							...
							<div class="form-group">
								...
								<textarea name="health_history" class="form-control" rows="6" cols="19"
									placeholder="Enter product description"></textarea>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">Weight</label>
								<textarea name="weight" class="form-control" rows="6" cols="19"
									placeholder="Weight"></textarea>
							</div>
							<div class="form-group">
	...
	if (isset($_POST['submit'])) {
		...
		$inset_product = "insert into cattle(breed,price,age,weight,health_history,image,qty) values ('$breed','$price','$age', '$weight','$health_history','$product_img1','$qty')";
